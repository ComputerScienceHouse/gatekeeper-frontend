  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
      <div className="container-lg">
        ...
        <div className={`collapse navbar-collapse${collapsed ? "" : " show"}`} id="navbar-lg-1">
          <ul className="navbar-nav me-auto">
            <li className="nav-item">
              <a href="/home" className="nav-link px-2">Home</a>
            </li>
            <li className="nav-item">
              <a href="/audit" className="nav-link px-2">Activity</a>
            </li>
            <li className="nav-item">
              <a href="/doors" className="nav-link px-2">Doors</a>
            </li>
          </ul>
...
function UserDropdown({
  ...
  return (
    <li className={`nav-item dropdown text-end${open ? " show" : ""}`}>
      ...
      <ul className={`dropdown-menu dropdown-menu-end text-small${open ? " show" : ""}`}>
        <li>
          <a
